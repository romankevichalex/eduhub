  ...
  <div class="subject-page">
    <div class="subject-top">
      ...
      <div class="tabs">
        ...
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M7.09 2.75a4 4 0 0 0-4 4v6.208a4 4 0 0 0 4 4h.093v3.792a.5.5 0 0 0 .839.368l4.52-4.16h4.369a4 4 0 0 0 4-4V6.75a4 4 0 0 0-4-4z"/></svg>
        </button>
        <button
          class="tab"
          ...
          @click="activeTab = 'ai'"
        >
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="1.5"><path stroke-linecap="round" d="M17.5 17.5L22 22"/><path d="M20 11a9 9 0 1 0-18 0a9 9 0 0 0 18 0Z"/><path stroke-linecap="round" d="m6.5 14l1.842-5.526a.694.694 0 0 1 1.316 0L11.5 14m3-6v6m-7-2h3"/></g></svg>
        </button>
        <button
          class="tab"
...
const goToComments = (postId) => {
  router.push(`/subjects/${subjectId.value}/comments/${postId}`)
}
...
.loading, .empty, .ai-placeholder, .widgets-placeholder {
  text-align: center;
  padding: 40px;
  color: #666;
}
